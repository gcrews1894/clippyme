 ...
 *
 * @param {{ type: 'url' | 'file', payload: string | File, instructions?: string, preselections?: { reframe_mode?: string } }} data
 * @param {string} apiKey
 ...
 *
 * @param {{ urls: string[], instructions?: string, preselections?: { reframe_mode?: string } }} data
 * @param {string} apiKey
